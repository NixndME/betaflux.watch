...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer className="border-t border-[#262626] bg-[#0A0A0A] text-slate-300 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-6 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-mono font-bold bg-amber-950 text-amber-300 border border-amber-800/60 px-2 py-0.5 rounded">
                  betaflux.watch
                </span>
              </div>
            </div>
          ...
          <div className="md:col-span-6 space-y-2 text-xs bg-[#141414] p-5 rounded-2xl border border-[#262626]">
            <div className="flex items-center gap-2 text-white font-bold">
              <Scale className="w-4 h-4 text-indigo-400" />
              <span>Public Interest Truth &amp; Whistleblower Protection</span>
            </div>
            <p className="text-slate-300 leading-relaxed text-[11px]">
              This repository strictly records factual corporate milestones, statutory filings, and primary exhibits. Under <strong className="text-white font-semibold">Exception 1 to Section 499 of the Indian Penal Code (Section 356 Bharatiya Nyaya Sanhita, 2023)</strong> and <strong className="text-white font-semibold">Article 19(1)(a)</strong> of the Constitution of India, publishing objective truth concerning corporate conduct for the public good and commercial due diligence is absolute protection against defamation claims.
            </p>
            <div className="text-[10px] text-slate-500 font-medium pt-1 flex items-center justify-between">
              ...
              <span className="font-mono text-amber-400">https://betaflux.watch</span>
            </div>
          </div>
        </div>

        {/* Bottom Bar */}
        <div className="pt-6 border-t border-[#262626] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400">
          <div>
            Zero PII leaks • All individual personal identifiers strictly masked • Hosted at <a href="https://betaflux.watch" className="text-amber-400 hover:underline font-mono">betaflux.watch</a>.
          </div>
